...
class GameWindow(ui.ScriptWindow):
	...
	def Open(self):
		import dbg
		try:
			dbg.TraceError("TARGET_INFO: app.ENABLE_SEND_TARGET_INFO is %s" % (str(app.ENABLE_SEND_TARGET_INFO)))
		except AttributeError:
			dbg.TraceError("TARGET_INFO: app.ENABLE_SEND_TARGET_INFO is NOT DEFINED (AttributeError)")
		except Exception as e:
			dbg.TraceError("TARGET_INFO: Error checking app flag: %s" % str(e))
	...
	def SetHPTargetBoard(self, vid, hpPercentage):
		if vid != self.targetBoard.GetTargetVID():
			...
			if app.ENABLE_SEND_TARGET_INFO:
				...
				import dbg
				dbg.TraceError("TARGET_INFO: SetHPTargetBoard called for VID %d via SetEnemyVID" % vid)
